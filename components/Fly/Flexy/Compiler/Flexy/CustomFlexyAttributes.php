...
// +----------------------------------------------------------------------+
//
/** Class called from Fly_Flexy_Compiler_Flexy_Tag's toString() method.
*	For handling new custom flexy namespaced attributes.
*/
class Fly_Flexy_Compiler_Flexy_CustomFlexyAttributes
{
    ...
    */
    ...
    {
        // Most of the this method is borrowed from parseAttributeIf() in Fly_Flexy_Compiler_Flexy_Tag
