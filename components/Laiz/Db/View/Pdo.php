 ...
 * @author    Satoshi Nishimura <nishim314@gmail.com>
 */
class Laiz_Db_View_Pdo implements Laiz_Db_View
{
    protected $db;

    public function __construct(Laiz_Db_Driver $db)
    {
        $this->db = $db;
    }
    ...
    public function createVo($sqlFile)
    {
        ...
        $className = 'Laiz_Db_Vo_' . implode('', array_map('ucfirst', explode('_', $sqlFile)));
